...
image2 = image2.resize((2000, 900), Image.ANTIALIAS)
...
l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"), bg="#2F4F4F", fg="white")
l1.place(x=600, y=50)

# that is for label1 registration

l2 = tk.Label(window, text="Full Name ", width=12, font=("Times new roman", 15, 'bold'), bg="#D3D3D3")
...
l3 = tk.Label(window, text="Address", width=12, font=("Times new roman", 15, "bold"), bg="#D3D3D3")
...
l5 = tk.Label(window, text="E-mail", width=12, font=("Times new roman", 15, "bold"), bg="#D3D3D3")
l5.place(x=550, y=250)
t4 = tk.Entry(window, textvar=Email, width=20, font=('', 15))
t4.place(x=750, y=250)
# that is for email address

l6 = tk.Label(window, text="Phone number", width=12, font=("Times new roman", 15, "bold"), bg="#D3D3D3")
l6.place(x=550, y=300)
t5 = tk.Entry(window, textvar=Phoneno, width=20, font=('', 15))
t5.place(x=750, y=300)
# phone number
l7 = tk.Label(window, text="Gender", width=12, font=("Times new roman", 15, "bold"), bg="#D3D3D3")
l7.place(x=550, y=350)
# gender
tk.Radiobutton(window, text="Male", padx=5, width=5, bg="#DCDCDC", font=("Times new roman", 15, 'bold'), variable=var, value=1).place(x=750,
                                                                                                                y=350)
tk.Radiobutton(window, text="Female", padx=20, width=5, bg="#DCDCDC", font=("Times new roman", 15, 'bold'), variable=var, value=2).place(
    x=850, y=350)

l8 = tk.Label(window, text="Age", width=12, font=("Times new roman", 15, "bold"), bg="#D3D3D3")
l8.place(x=550, y=400)
t6 = tk.Entry(window, textvar=age, width=20, font=('', 15))
t6.place(x=750, y=400)

l4 = tk.Label(window, text="User Name", width=12, font=("Times new roman", 15, "bold"), bg="#D3D3D3")
l4.place(x=550, y=450)
t3 = tk.Entry(window, textvar=username, width=20, font=('', 15))
t3.place(x=750, y=450)

l9 = tk.Label(window, text="Password", width=12, font=("Times new roman", 15, "bold"), bg="#D3D3D3")
l9.place(x=550, y=500)
t9 = tk.Entry(window, textvar=password, width=20, font=('', 15), show="*")
t9.place(x=750, y=500)

l10 = tk.Label(window, text="Confirm Password", width=13, font=("Times new roman", 15, "bold"), bg="#D3D3D3")
l10.place(x=550, y=550)

t10 = tk.Entry(window, textvar=password1, width=20, font=('', 15), show="*")
t10.place(x=750, y=550)

btn = tk.Button(window, text="Register", bg="#2F4F4F",font=("Times new roman",20, 'bold'),fg="white", width=9, height=1, border=5, command=insert)
